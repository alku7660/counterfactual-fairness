...
class Counterfactual:
    ...
    def __init__(self, data, model, method, alpha=1, dev=False, eff=False, type='L1_L0', percentage_close_train_cf=0.1, support_th=0.01, continuous_bins=continuous_bins):
        self.data = data
        self.model = model
        self.method = method
