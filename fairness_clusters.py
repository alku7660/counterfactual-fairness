...
datasets = ['adult','german','dutch'] # ['adult','kdd_census','german','dutch','bank','credit','compass','diabetes','student','oulad','law']
methods_to_run = ['nn','cchvae','ijuice'] # ['nn','mo','ft','rt','gs','face','dice','cchvae'] 
