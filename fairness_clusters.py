...
datasets = ['german','synthetic_athlete','student'] # 'dutch','german','synthetic_athlete','student','compass','adult'
methods_to_run = ['BIGRACE_dist','BIGRACE_dev_dist'] # ['BIGRACE_dist','BIGRACE_l','BIGRACE_e','BIGRACE_dev_dist','BIGRACE_dev_like','BIGRACE_dev_eff','ARES','FACTS'] 'BIGRACE_dist','BIGRACE_e','ARES','FACTS'
