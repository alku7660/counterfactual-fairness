...
datasets = ['kdd_census','german','dutch'] # ['adult','kdd_census','german','dutch','bank','credit','compass','diabetes','student','oulad','law']
methods_to_run = ['nn','cchvae'] # ['nn','mo','ft','rt','gs','face','dice','cchvae'] 
