...
def metric_differences_plot(datasets, methods_to_run, cf_metrics):
    """
        ...
        for feat in x_df.columns:
            ...
            for metric in cf_metrics:
                ...
                if prot_feat_found:
                    ...
                    plt.savefig(results_cf_plots_dir+f'{data_str}_{feat}_{metric}_fairness.png',dpi=400)
...
cf_metrics = ['proximity','sparsity']

metric_differences_plot(datasets, methods_to_run, cf_metrics)