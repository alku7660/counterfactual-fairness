        ...
        for feat_unique_val in feat_unique_val_list:
            ...
            for i in range(1,int(len(test_undesired_index)*perc)):
                if instances_feat_val_evaluated >= instances_per_protected_class:
                    ...
                    if x_jce_pd[feat] != feat_unique_val or idx in idx_instances_evaluated:
                        continue
                    else:
                        print(f'---------------------------')
                        print(f'     Dataset: {data_str}')
                        ...
                        print(f'  Feat: {feat}')
                        print(f'  Feat value: {x_jce_pd[feat]}')
                        print(f'  Instances feat value: {instances_feat_val_evaluated}')
                        print(f'---------------------------')
