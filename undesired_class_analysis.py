...
datasets = ['oulad','law'] # Name of the dataset to be analyzed ['adult','kdd_census','german','dutch','bank','credit','compass','diabetes','student','oulad','law']
...
instances_per_feature_val = 30
instances_desired_ground_truth = 100
